...
ENTRY-2026-05-31T06:33:00Z: 86ca1u4ef -> in review
...
ENTRY-2026-06-01T05:55:00Z: 86ca2187n -> in review
```
...
ENTRY-2026-05-29T15:45:00Z: 86ca1fntp -> in progress (Maya accepted dispatch — per-animation playback overrides + mid-sequence peak-frame dwell in spritePlayer.ts; 50%/70% speed list + coffee/snack/phone/stretch peak dwell for M01+F01)
ENTRY-2026-05-29T16:00:00Z: 86ca1fntp -> in review (Maya PR opened — feat(webview): per-animation playback overrides + peak-frame dwell — PLAYBACK_OVERRIDES table + resolvePlayback; 44 sprite tests green)
ENTRY-2026-05-29T16:00:00Z: 86ca1gdbp -> in progress (Felix accepted dispatch — remove global "Hide finished" / "Hide idle" chips + their settings/commands/messages/state-filters; per-member hide/remove untouched; branch felix/86ca1gdbp-remove-hide-chips)
...
ENTRY-2026-06-11T23:46:30Z: 86ca5eve1 -> in progress (Iris accepted dispatch — Phase 1: apex-hold dwellMs/dwellFrameIndex tuner-spec amendment; branch iris/86ca5eve1-tuner-spec-amendment. NOTE for orch: ticket premise stale — apex controls already SHIPPED on origin/main f1ae6a73 via 86ca2bqe1; amendment reconciles the E4 spec to that reality rather than specifying a net-new control)
ENTRY-2026-06-11T23:48:00Z: 86ca5eve1 -> in review (Iris PR #212 opened — spec(tuner): un-LOCK field set for apex-hold dwellMs/dwellFrameIndex; §12 added + §10 OOS #3 superseded; control-type decision = dwellMs ms-slider mirroring finalDwellMs + dwellFrameIndex window-bounded <select> over stepper/slider; reviewer Felix. Stale-premise flagged in PR body — apex already shipped, amendment is doc-reconciling)
